$execute unless items block ~ ~ ~ container.0 * run return run item replace block ~ ~ ~ container.0 with $(item) $(count)
...
$execute unless items block ~ ~ ~ container.1 * run return run item replace block ~ ~ ~ container.1 with $(item) $(count)
...
$execute unless items block ~ ~ ~ container.2 * run return run item replace block ~ ~ ~ container.2 with $(item) $(count)
...
$execute unless items block ~ ~ ~ container.3 * run return run item replace block ~ ~ ~ container.3 with $(item) $(count)
...
$execute unless items block ~ ~ ~ container.4 * run return run item replace block ~ ~ ~ container.4 with $(item) $(count)
...
data modify storage buried:temp resource_spawner.failed_to_set_hopper set value 1b