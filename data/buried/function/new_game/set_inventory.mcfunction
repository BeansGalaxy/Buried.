execute if items entity @s player.cursor diamond_pickaxe run function buried:new_game/ready_up
...
execute if entity @s[tag=buried.new_game.ready] run return run item replace entity @s hotbar.0 with stone_pickaxe[item_name={text:"Waiting for players..."},tooltip_display={hidden_components:["attribute_modifiers"]}]
